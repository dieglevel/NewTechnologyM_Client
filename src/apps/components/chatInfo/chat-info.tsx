  ...
  return (
    <View style={[styles.container, isDark && styles.darkContainer]}>
      ...
      <View style={styles.profileContainer}>
        <Image
          source={{
            uri: "https://tse4.mm.bing.net/th?id=OIP.3AiVQskb9C_qFJB52BzF7QHaHa&pid=Api&P=0&h=180",
          }}
          style={styles.avatar}
        />
        <View style={styles.nameRow}>
          <Text style={[styles.nameText, isDark && styles.darkNameText]}>Minh</Text>
          <TouchableOpacity
            style={styles.editIcon}
            onPress={() => alert("Chỉnh sửa biệt danh")}
          >
            <Feather name="edit-2" size={16} color={isDark ? "#e5e7eb" : "#333"} />
          </TouchableOpacity>
        </View>
      </View>
      ...
      <View style={styles.featuresContainer}>
        <View style={styles.featureRow}>
          <TouchableOpacity style={styles.featureItem} onPress={() => alert("Tắt thông báo")}>
            <View style={styles.iconCircle}>
              <Feather name="bell-off" size={20} color="#1e3a8a" />
            </View>
            <Text style={styles.featureText}>Tắt thông báo</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.featureItem} onPress={() => alert("Ghim hội thoại")}>
            <View style={styles.iconCircle}>
              <Feather name="bookmark" size={20} color="#1e3a8a" />
            </View>
            <Text style={styles.featureText}>Ghim hội thoại</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.featureItem} onPress={() => alert("Tạo nhóm trò chuyện")}>
            <View style={styles.iconCircle}>
              <Feather name="user-plus" size={20} color="#1e3a8a" />
            </View>
      ...
      <ScrollView style={styles.content}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.securityItem}>
            <View style={styles.securityRow}>
              ...
              <TouchableOpacity onPress={() => alert("Thông tin về tắt thông báo")}>
                <Feather name="help-circle" size={20} color={isDark ? "#60a5fa" : "#3b82f6"} />
              </TouchableOpacity>
            </View>
            <Switch
              value={isMuted}
          ...
          <TouchableOpacity style={styles.securityItem} onPress={deleteChatHistory}>
            <View style={styles.securityRow}>
              <Feather
                name="alert-triangle"
